...
export default function PharmacyScreen({navigation}) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        'https://joeswantonsing.github.io/CIC_Data/api/health/pharmacies.json',
      )
      .then((res) => {
  ...
  return (
    <SafeAreaView style={styles.savStyle}>
      <View style={styles.introSection}>
        ...
        />
        <View>
          <Text style={styles.introText}>Listing All Pharmacies</Text>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.listContainer}>
          {pharmacies.map((pharmacy) => (
            <HealthCard key={pharmacy.id} cardData={pharmacy} />
          ))}
        </View>
      </ScrollView>
    </SafeAreaView>
